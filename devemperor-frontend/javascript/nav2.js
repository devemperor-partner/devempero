...
document.querySelector("#cancel").onclick = () => {
  ...
  document.querySelector("#main").className = "main-stretch";
  document.querySelector("#dashboard_log").className = "dashboard-log-stretch";
};

document.querySelector("#harmburger").onclick = () => {
  document.querySelector("#nav").className = "nav-show";
  document.querySelector("#main").className = "";
  document.querySelector("#dashboard_log").className = "dashboard-log";
};
