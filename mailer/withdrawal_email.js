    ...
    html: `
        ...
        <div class="mail_template"
            ...
            <div style="text-align: center; margin-top: 20px;">
                <h3 style="font-size: 24px; font-weight: bold; color: #333;">Withdrawal Request Notification</h3>
            </div>
            <div style="margin-top: 30px;">
                <p style="font-size: 18px; color: #555;">Dear ${userInfo.full_name},</p>
                <p style="font-size: 18px; color: #555;">We recieved your request to make a withdrawal of ₦${userInfo.withdrawal_amount}.</p>
                <p style="font-size: 18px; color: #555;">If you did not initiate this transaction please contact our customer support immediately before funds get transferred</p>
