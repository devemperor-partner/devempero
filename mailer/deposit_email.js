    ...
    html: `
        ...
        <div class="mail_template"
            ...
            <div style="margin-top: 30px;">
                ...
                <p style="font-size: 18px; color: #555;">We recieved your request to make a deposit of ₦${userInfo.deposit_amount}.</p>
                <p style="font-size: 18px; color: #555;">Copy the account details provided and make corresponding payment. your account would be credited once we recieve funds</p>
