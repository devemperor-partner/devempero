...
const validate_update_mobile_app_information = (req) => {
  const schema = Joi.object({
    ...
    mobile_app_category: Joi.string().required(),

    Would_you_need_a_website_for_this_app_later: Joi.string().required(),
    ...
    Why_do_you_need_a_mobile_app: Joi.string().allow(""),
  ...
  const result = schema.validate({
    user: req.user,
    appID: req.appID,
    mobile_app_category: req.mobile_app_category,

    Would_you_need_a_website_for_this_app_later:
      req.Would_you_need_a_website_for_this_app_later,
    ...
    Why_do_you_need_a_mobile_app: req.Why_do_you_need_a_mobile_app,

    Who_is_your_target_audience: req.Who_is_your_target_audience,

    what_will_make_this_mobile_app_stand_out_the_competition:
      req.what_will_make_this_mobile_app_stand_out_the_competition,

    who_are_your_top_competitors: req.who_are_your_top_competitors,

    What_would_you_like_to_have_on_your_mobile_app_regarding_to_branding_and_styling:
      req.What_would_you_like_to_have_on_your_mobile_app_regarding_to_branding_and_styling,
